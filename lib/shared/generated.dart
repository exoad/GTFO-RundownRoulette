  ...
  static final Preset vanilla = Preset(
    <Rundown>[
      ...
      Rundown("ALT://Rundown 6.0 \"Destination\"", const <Mission>[
        Mission(canonicalName: "R6A1 \"ARTIFACT 7\"", tier: "A", number: 1, isLore: true),
        Mission(canonicalName: "R6AX \"DUST\"", tier: "A", number: 10, isLore: true),
        Mission(canonicalName: "R6B1 \"HEXAHEDRONS\"", tier: "B", number: 1, isLore: true),
        Mission.secondary(canonicalName: "R6B2 \"CONTAMINANT\"", tier: "B", number: 2),
        Mission.secondary(canonicalName: "R6BX \"FLUX\"", tier: "B", number: 10, isLore: true),
        Mission(canonicalName: "R6C1 \"NAVIGATION\"", tier: "C", number: 1, isLore: true),
        ...
        Mission(canonicalName: "R6CX \"ASCENT\"", tier: "C", number: 10, isLore: true),
        Mission(canonicalName: "R6D1 \"NEMESIS\"", tier: "D", number: 1, isLore: true),
      ...
      Rundown("Rundown 7.0 \"RISE\"", const <Mission>[
        Mission(canonicalName: "R7A1 \"UNIT 23\"", tier: "A", number: 1, isLore: true),
        Mission(canonicalName: "R7B1 \"CARGO\"", tier: "B", number: 1, isLore: true),
        ...
        Mission(canonicalName: "R7C1 \"MONSTER\"", tier: "C", number: 1, isLore: true),
        ...
        Mission.secondary(canonicalName: "R7D1 \"MOTHER\"", tier: "D", number: 1, isLore: true),
        Mission(canonicalName: "R7D2 \"AWOL\"", tier: "C", number: 2, isLore: true),
        Mission(canonicalName: "R7E1 \"CHAOS\"", tier: "E", number: 1),
      ]),
      Rundown("Rundown 8.0 \"Duality\"", const <Mission>[
        Mission(canonicalName: "R8A1 \"ORDER\"", tier: "A", number: 1, isLore: true),
        Mission.secondary(
          canonicalName: "R8A2 \"PERSPECTIVE\"",
          tier: "A",
          number: 2,
          isLore: true,
        ),
        Mission.secondary(canonicalName: "R8B1 \"EFFECT\"", tier: "B", number: 1, isLore: true),
        Mission.secondary(canonicalName: "R8B2 \"WARP\"", tier: "B", number: 2, isLore: true),
        Mission.secondary(canonicalName: "R8B3 \"CAUSE\"", tier: "B", number: 3, isLore: true),
        Mission.secondary(
          canonicalName: "R8B4 \"INSURRECTION\"",
          tier: "B",
          number: 4,
          isLore: true,
        ),
        Mission.prisonerEfficiency(
          canonicalName: "R8C1 \"LINK\"",
          tier: "C",
          number: 1,
          isLore: true,
        ),
        Mission(canonicalName: "R8C2 \"UNPLUGGED\"", tier: "C", number: 2, isLore: true),
        Mission(canonicalName: "R8D1 \"TANDEM\"", tier: "D", number: 1, isLore: true),
        Mission.secondary(canonicalName: "R8D2 \"SLAUGHTER\"", tier: "D", number: 2, isLore: true),
        Mission.secondary(canonicalName: "R8E1 \"VALIANT\"", tier: "E", number: 1, isLore: true),
        Mission.secondary(canonicalName: "R8E2 \"RELEASE\"", tier: "E", number: 2, isLore: true),
      ]),
    ],
    const <MeleeWeapon>[
      MeleeWeapon.bat(),
